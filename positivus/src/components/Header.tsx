...
const Header = ({darkMode, toggleDarkMode, toggleSidebar}:{darkMode:boolean, toggleDarkMode:any, toggleSidebar:any}) => {
  return (
    <nav className="fixed top-0 z-50 w-full border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            ...
            <a href="#" className="flex ms-2 md:me-24 "><MdSpaceDashboard className="h-8 me-3 text-xl text-violet-500"  /> 
