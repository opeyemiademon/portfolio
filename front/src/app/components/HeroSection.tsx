...
const HeroSection =()=> {
  return (
    <section className='lg:py-16'>
        ...
        <h1 className="text-white mb-4 text-4xl ld:leading-normal lg:text-6xl sm:text-5xl font-extrabold">
    ...
    />
        ...
        <p className='text-[#ADB7BE] sm:text-lg lg:text-xl mb-6 text-base '>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quae fuga dolor</p>
       

<div>
        <button className='px-6 py-3 sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-primary-500  to-secondary-500 hover:bg-slate
        -200 text-white w-full '>Hire me</button>
